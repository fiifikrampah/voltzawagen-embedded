...
void setup() {
 // Set Reset pin to LOW then HIGH
  //digitalWrite(13,1);
  //delay(100);
  //digitalWrite(13,1);
  //delay(100);
...
void loop() {
  ...
  double curr,volt,instPower,totPower,foo;

  std::vector<double> voltageBuffer; 
  ...
  // Serial.println(foo, 5);
    ...
    //  curr = line.getInstI();
    //  volt = line.getInstV();
    //  instPower = line.getInstP();
    //  totPower = line.getTotalP();



    //  Serial.print("DC instant current: \n");
    //  Serial.println(curr,10);

    //  Serial.print("DC instant voltage: \n");
    //  Serial.println(volt,10);

    //  Serial.print("DC instant power: \n");
    //  Serial.println(instPower,10);

    //  Serial.print("DC total power: \n");
    //  Serial.println(totPower,10);     
  ...
  */
  line.calibrate(DCoffset,Voltage);
  ...
  foo = line.getPeakI();
  Serial.print("DC current value: ");
  Serial.println(foo, 20);

  foo = line.getInstV();
  voltageBuffer.push_back(foo); // add voltage to voltage buffer

  Serial.print("DC voltage value: ");
  Serial.println(foo, 20);
  foo = line.getInstP();
  Serial.print("DC power value: ");
  Serial.println(foo, 20);
  foo = line.getTotalP();
  Serial.print("DC total power: ");
  Serial.println(foo, 20);

  Serial.println("\nReset ESP8266 to see it again... ");
...
//                         // may need to comment out this CRC condition
//                         if(!CRC)
//                         {
//                           Serial.println();
//                           Serial.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
